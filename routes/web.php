...
Route::post('/user_comment/{id}', [HomeController::class, 'user_comment'])->middleware('auth');

Route::get('/reject_comment/{id}', [AdminController::class, 'reject_comment']);
Route::get('/accept_comment/{id}', [AdminController::class, 'accept_comment']);
Route::get('/delete_comment/{id}', [AdminController::class, 'delete_comment']);
// routes/web.php

// routes/web.php

Route::post('/posts/restore_latest', [AdminController::class, 'restoreLatest'])->name('posts.restoreLatest');
